...
import com.Selenium_assignment.pages.LoginPage;
...
public class LoginPageTest extends BaseTest{
  ...
  public void LoginValidmailid() {
	  ...
	  login.sendMaildId("gtanu848@gmail.com");
	  login.clickContinue();
	  login.sendPassword("Qw@123456");
	  login.clickSubmit();
  ...
  public void Loginvalidmailid() {
	  ...
	  LoginPage login=new LoginPage(driver);
	  login.clickSignInOption();
	  login.sendMaildId("gtanu84888@gmail.com");
	  login.clickContinue();
	  Assert.assertEquals(driver.getTitle(),"Amazon Sign In");
  ...
  public void LogininValidPassword() {
	  ...
	  login.sendMaildId("gtanu848@gmail.com");
	  login.clickContinue();
	  login.sendPassword("Qw@12345678");
	  login.clickSubmit();
	  Assert.assertEquals(driver.getTitle(),"Amazon Sign In");
